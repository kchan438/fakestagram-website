function createCard(data) {
    ...
    return `<div id=image-post-${data.id} class="imagepost"> \
                  ...
                  <div class="postbody"> \
                    ...
                    <a href="/posts/postimage/${data.id}" class="anchor-buttons">Details</a> \
                  </div> \
            </div>`;
    ...
    fetch("http://localhost:3000/posts/getMostRecent/")
    .then((data) => data.json())
    .then((dataAsObject) => {
      ...
      document.getElementById('index-section').innerHTML = _html;
