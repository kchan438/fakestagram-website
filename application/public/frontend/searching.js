function createCard(data) {
  ...
  function runSearch() {
    ...
    let searchURL = 'http://localhost:3000/posts/search/' + searchString;
    fetch(searchURL)
    .then((data) => data.json())
    .then((dataAsObject) => {
      ...
      document.getElementById('search-section').innerHTML = _html;
  ...
  document.getElementById('searchsubmit').onclick = runSearch;